...
CREATE TABLE MovieItem (
    id            varchar(128) NOT NULL,
    primary_collection_id varchar(128) NOT NULL,
    position      int NULL,
    [title]       nvarchar(500) NOT NULL,
    [path]        nvarchar(1000) NULL,
...
CREATE TABLE Season (
    id            varchar(128) NOT NULL,
    primary_series_id     varchar(128) NOT NULL,
...
CREATE TABLE Episode (
    id             varchar(128) NOT NULL,
    primary_season_id      varchar(128) NOT NULL,
...
CREATE TABLE SkipSet (
    id         varchar(128) NOT NULL,
    primary_episode_id varchar(128) NOT NULL,
...
CREATE TABLE SkipRange (
    id          varchar(128) NOT NULL,
    primary_skip_set_id varchar(128) NOT NULL,
